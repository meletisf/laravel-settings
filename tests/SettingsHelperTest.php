...
class SettingsHelperTest extends TestCase
{
    ...
    /** @test */
    public function helper_returns_settings_service()
    {
    ...
    /** @test */
    public function helper_returns_setting_if_string_is_given()
    {
        $this->app->singleton('laravel-settings', fn ($app) => new Settings($this->getServiceConfiguration()));
    ...
    /** @test */
    public function helper_sets_setting_if_array_is_given()
    {
        $this->app->singleton('laravel-settings', fn ($app) => new Settings($this->getServiceConfiguration()));
